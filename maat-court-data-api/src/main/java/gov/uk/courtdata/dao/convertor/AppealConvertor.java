...
import gov.uk.courtdata.dao.oracle.AppealsType;
...
public class AppealConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof AppealDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AppealDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setAppealReceivedDate(
                            convertorHelper.toDate(getOracleType().getAppealReceivedDate()));
            getDTO().setAppealSentenceOrderDate(
                            convertorHelper.toDate(getOracleType().getAppealSentenceOrderDate()));
            getDTO().setAppealSentOrderDateSet(
                            convertorHelper.toDate(getOracleType().getAppealSentOrdDtDateSet()));

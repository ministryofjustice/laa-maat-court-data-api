...
public class UserSessionConvertor extends Convertor {
     ...
     */
    @Override
    public UserSessionType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof UserDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + UserDTO.class.getName());
    }

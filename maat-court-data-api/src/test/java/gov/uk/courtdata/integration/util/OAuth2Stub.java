...
public class OAuth2Stub {
    ...
    private static final String OAUTH2_TOKEN_URI =
            "http://localhost:" + MockMvcIntegrationTest.WIREMOCK_PORT + OAUTH2_TOKEN_PATH;
    ...
    public void applyStubTo(WireMockServer wireMockServer) {
        ...
        wireMockServer.stubFor(WireMock.post(OAUTH2_TOKEN_PATH)
    ...
    private String serialiseOAuth2TokenToJson(ObjectMapper mapper, Map<String, Object> oAuthToken) {
        try {
            ...
            String message = "Unable to serialise OAuth2 token [%s] due to: [%s]".formatted(oAuthToken, e.getMessage());

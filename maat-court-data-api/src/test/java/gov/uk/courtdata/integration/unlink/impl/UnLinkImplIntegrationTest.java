...
class UnLinkImplIntegrationTest extends MockMvcIntegrationTest {
    ...
    private void assertWQCore(UnlinkModel unlinkModel) {
        ...
        assertThat(unLinkCore.getCreatedUserId())
                .isEqualTo(unlinkModel.getUnlink().getUserId());
    ...
    private void assertUnLinkOtherReason(UnlinkModel unlinkModel) {
        ...
        assertThat(unLinkReason.getCaseId())
                .isEqualTo(unlinkModel.getWqLinkRegisterEntity().getCaseId());
        assertThat(unLinkReason.getReasonId()).isEqualTo(unlinkModel.getUnlink().getReasonId());
        assertThat(unLinkReason.getOtherReason())
                .isEqualTo(unlinkModel.getUnlink().getOtherReasonText());
    }
}

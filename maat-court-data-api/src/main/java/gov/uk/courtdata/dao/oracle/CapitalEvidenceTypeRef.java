...
public class CapitalEvidenceTypeRef implements ORAData, ORADataFactory {
    ...
    public static CapitalEvidenceTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CapitalEvidenceTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CapitalEvidenceTypeRef: " + exn.toString());
        }
    }

    public CapitalEvidenceType getValue() throws SQLException {
        return (CapitalEvidenceType) CapitalEvidenceType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

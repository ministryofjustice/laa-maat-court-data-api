...
public class AreaTransferType implements ORAData, ORADataFactory {
    ...
    public AreaTransferType(
            ...
            String userCreated,
            TransferStatusType statusObject,
            AreaType areaFromObject,
            AreaType areaToObject,
            TransferTypeType transferTypeObject,
            CmuType cmuFromObject,
            CmuType cmuToObject,
            java.sql.Timestamp dateHmcsSent,
            java.sql.Timestamp dateHmcsReceived,
            UserType hmcsSentByUserObject,
            UserType hmcsReceivedByUserObject,

...
public class CorrespondenceTypeRef implements ORAData, ORADataFactory {
    ...
    public static CorrespondenceTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CorrespondenceTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CorrespondenceTypeRef: " + exn.toString());
        }
    }

    public CorrespondenceType getValue() throws SQLException {
        return (CorrespondenceType) CorrespondenceType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class HardshipOverviewConvertor extends Convertor {
     ...
     */
    @Override
    public HardshipOverviewType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof HardshipOverviewDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setCrownCourtHardship(
                            crwnConvertor.getDTO()); // if type is null this will initialise a valid empty object
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setCrownHardshipObject(
                            crwnConverter.getOracleType()); // if type is null this will initialise a valid empty object

...
public class CapitalEvidenceSummaryConvertor extends Convertor {
     ...
     */
    @Override
    public CapitalEvidenceSummaryType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CapitalEvidenceSummaryDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CapitalEvidenceSummaryDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setCapitalAllowWithheldDate(
                            convertorHelper.toDate(getOracleType().getCapitalAllowWithheldDate()));
            getDTO().setCapitalAllowReinstatedDate(
                            convertorHelper.toDate(getOracleType().getCapitalAllowReinstatedDate()));
            ...
            getDTO().setCapitalAllowance(
                            convertorHelper.toDouble(getOracleType().getCapitalAllowance()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setCapitalAllowReinstatedDate(convertorHelper.toDate(getDTO().getCapitalAllowReinstatedDate()));

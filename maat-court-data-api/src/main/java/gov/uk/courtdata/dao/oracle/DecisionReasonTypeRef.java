...
public class DecisionReasonTypeRef implements ORAData, ORADataFactory {
    ...
    public static DecisionReasonTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (DecisionReasonTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to DecisionReasonTypeRef: " + exn.toString());
        }
    }

    public DecisionReasonType getValue() throws SQLException {
        return (DecisionReasonType) DecisionReasonType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

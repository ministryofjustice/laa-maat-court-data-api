...
public class ApplicantConvertor extends Convertor {
     ...
     */
    @Override
    public ApplicantDetailsType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ApplicantDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AddressDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setApplicantHistoryId(
                            convertorHelper.toLong(getOracleType().getAphiId()));
            ...
            getDTO().setUseSupplierAddrForPost(
                            convertorHelper.toBoolean(getOracleType().getUseSuppAddrForPost()));
            getDTO().setSurname(convertorHelper.toString(getOracleType().getLastName()));
            getDTO().setSpecialInvestigation(
                            convertorHelper.toDate(getOracleType().getSpecialInvestigation()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if ((getDTO().getDisabilities() != null)
                    && (getDTO().getDisabilities().size() > 0)) {

                DisabilityType[] disabilityTypes =
                        new DisabilityType[getDTO().getDisabilities().size()];

...
public class VehicleRegistrationMarkConvertor extends Convertor {
     ...
     */
    @Override
    public MvoRegType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof VehicleRegistrationMarkDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + VehicleRegistrationMarkDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setVehicleRegistrationMark(
                            convertorHelper.toString(getOracleType().getRegistration()));

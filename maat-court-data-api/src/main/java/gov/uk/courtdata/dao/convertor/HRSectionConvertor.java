...
public class HRSectionConvertor extends Convertor {
     ...
     */
    @Override
    public HrSectionType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof HRSectionDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setApplicantAnnualTotal(
                            convertorHelper.toCurrency(getOracleType().getAppAnnualTotal()));
            getDTO().setPartnerAnnualTotal(
                            convertorHelper.toCurrency(getOracleType().getPartnerAnnualTotal()));

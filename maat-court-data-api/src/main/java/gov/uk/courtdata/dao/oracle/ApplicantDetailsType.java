...
public class ApplicantDetailsType implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 12, 12, 12, 12, 91, 12, 12, 12, 2002, 2003, 2002, 12, 12, 12, 12, 12, 2002, 2002, 2, 2002, 91, 93, 12
    };
    ...
    public ApplicantDetailsType(
            ...
            String foreignId,
            String disabled,
            EthnicityType ethnicityObject,
            DisabilitiesTabtype appDisabilitiesTab,
            EmpStatusType empStatusObject,
            String phoneMobile,
            String phoneHome,
            String email,
            String noFixedAbode,
            String useSuppAddrForPost,
            AddressType homeAddressObject,
            AddressType postAddressObject,
            java.math.BigDecimal aphiId,
            ApplPaymentDetailsType applPaymentDetailsObject,
            java.sql.Timestamp specialInvestigation,

...
public class FullAssessmentTypeRef implements ORAData, ORADataFactory {
    ...
    public static FullAssessmentTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (FullAssessmentTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to FullAssessmentTypeRef: " + exn.toString());
        }
    }

    public FullAssessmentType getValue() throws SQLException {
        return (FullAssessmentType) FullAssessmentType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

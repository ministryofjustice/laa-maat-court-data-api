...
public class ResultServiceTest {
    ...
    public void givenAValidCaseIdAndAsnSeq_whenFindResultCodesByCaseIdAndAsnSeqIsInvoked_shouldReturnIntegerList() {
        when(resultRepository.findResultCodeByCaseIdAndAsnSeq(
                        TestEntityDataBuilder.TEST_CASE_ID, TestEntityDataBuilder.TEST_ASN_SEQ))
                .thenReturn(List.of(TestModelDataBuilder.TEST_RESULT_CODE));
        resultsService.findResultCodesByCaseIdAndAsnSeq(
                TestEntityDataBuilder.TEST_CASE_ID, TestEntityDataBuilder.TEST_ASN_SEQ);
    ...
    public void givenAValidCaseIdAndAsnSeq_whenFindWQResultCodesByCaseIdAndAsnSeqIsInvoked_shouldReturnIntegerList() {
        when(wqResultRepository.findResultCodeByCaseIdAndAsnSeq(
                        TestEntityDataBuilder.TEST_CASE_ID, TestEntityDataBuilder.TEST_ASN_SEQ))
                .thenReturn(List.of(TestModelDataBuilder.TEST_RESULT_CODE));
        resultsService.findWQResultCodesByCaseIdAndAsnSeq(
                TestEntityDataBuilder.TEST_CASE_ID, TestEntityDataBuilder.TEST_ASN_SEQ);
    ...
    @Test
    public void
            givenAValidResultCodeAvailable_whenFindXLATResultCodesForCCImprisonmentIsInvoked_shouldReturnXLATResultEntityList() {
    ...
    @Test
    public void
            givenAValidResultCodeAvailable_whenFindXLATResultCodesForCCBenchWarrantIsInvoked_shouldReturnXLATResultEntityList() {
    ...
    @Test
    public void
            givenValidWQTypeAndSubType_whenFindXLATResultCodesByWQTypeAndSubTypeCodeIsInvoked_shouldReturnIntegerList() {
        Integer wqType = 1234;

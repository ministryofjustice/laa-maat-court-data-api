...
public class DebtCollectionRepository {
    ...
    private void runContributionFilesSqlStatement(ContributionFilesEntity contributionFilesEntity, boolean isUpdate) {
        ...
        Map<String, String> fieldValueMap =
                ContributionFileUtil.generateSqlFieldValueMap(contributionFilesEntity, isUpdate);
        if (isUpdate) {
        ...
        jdbcTemplate.update(
                con -> {
                    ...
                    ContributionFileUtil.setPreparedStatementParameters(
                            ps, fieldValueMap, contributionFilesEntity, xmlClob, ackClob, isUpdate);

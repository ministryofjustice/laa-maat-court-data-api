...
public class DigiMeansAssessTypeRef implements ORAData, ORADataFactory {
    ...
    public static DigiMeansAssessTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (DigiMeansAssessTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to DigiMeansAssessTypeRef: " + exn.toString());
        }
    }

    public DigiMeansAssessType getValue() throws SQLException {
        return (DigiMeansAssessType) DigiMeansAssessType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

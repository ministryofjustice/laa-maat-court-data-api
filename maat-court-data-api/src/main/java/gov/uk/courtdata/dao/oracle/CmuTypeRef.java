...
public class CmuTypeRef implements ORAData, ORADataFactory {
    ...
    public static CmuTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CmuTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
    ...
    public CmuType getValue() throws SQLException {
        return (CmuType) CmuType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

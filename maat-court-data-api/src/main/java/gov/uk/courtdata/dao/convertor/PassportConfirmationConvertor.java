...
public class PassportConfirmationConvertor extends Convertor {
     ...
     */
    @Override
    public PassportConfirmationType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof PassportConfirmationDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + PassportConfirmationDTO.class.getName());
    }

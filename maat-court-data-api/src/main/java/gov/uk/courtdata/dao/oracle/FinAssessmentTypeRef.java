...
public class FinAssessmentTypeRef implements ORAData, ORADataFactory {
    ...
    public static FinAssessmentTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (FinAssessmentTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to FinAssessmentTypeRef: " + exn.toString());
        }
    }

    public FinAssessmentType getValue() throws SQLException {
        return (FinAssessmentType) FinAssessmentType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

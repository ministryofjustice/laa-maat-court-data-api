...
public class ContraryInterestTypeRef implements ORAData, ORADataFactory {
    ...
    public static ContraryInterestTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (ContraryInterestTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to ContraryInterestTypeRef: " + exn.toString());
        }
    }

    public ContraryInterestType getValue() throws SQLException {
        return (ContraryInterestType)
                ContraryInterestType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

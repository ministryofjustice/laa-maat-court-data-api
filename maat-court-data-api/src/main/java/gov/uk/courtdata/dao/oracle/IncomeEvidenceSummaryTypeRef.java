...
public class IncomeEvidenceSummaryTypeRef implements ORAData, ORADataFactory {
    ...
    private static final IncomeEvidenceSummaryTypeRef _IncomeEvidenceSummaryTypeRefFactory =
            new IncomeEvidenceSummaryTypeRef();
    ...
    public static IncomeEvidenceSummaryTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (IncomeEvidenceSummaryTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException("Unable to convert " + o.getClass().getName() + " to IncomeEvidenceSummaryTypeRef: "
                    + exn.toString());
        }
    }

    public IncomeEvidenceSummaryType getValue() throws SQLException {
        return (IncomeEvidenceSummaryType)
                IncomeEvidenceSummaryType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

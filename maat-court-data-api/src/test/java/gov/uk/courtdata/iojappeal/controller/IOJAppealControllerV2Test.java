...
class IOJAppealControllerV2Test {
    ...
    @Test
    void givenValidLegacyIojAppealId_whenGetIojAppealIsCalled_thenOkResponseIsReturned() throws Exception {
    ...
    @Test
    void givenNonExistentAppeal_whenGetIOJAppealIsCalled_thenNotFoundResponseIsReturned() throws Exception {
        when(iojAppealService.find(LEGACY_IOJ_APPEAL_ID))
                .thenThrow(new RequestedObjectNotFoundException("No IoJ Appeal found for ID: " + LEGACY_IOJ_APPEAL_ID));
    ...
    @Test
    void givenValidCreateIojAppealRequest_whenCreateIojAppealIsCalled_thenOkResponseIsReturned() throws Exception {
        var apiCreateIojAppealResponse = TestModelDataBuilder.getApiCreateIojAppealResponse();

        when(iojAppealService.create(any(ApiCreateIojAppealRequest.class))).thenReturn(apiCreateIojAppealResponse);
    ...
    @Test
    void givenInvalidCreateIOJAppeal_whenCreateIOJAppealIsCalled_thenBadRequestIsReturned() throws Exception {
    ...
    @Test
    void givenMissingRequestBody_whenCreateIojAppealIsCalled_thenBadRequestIsReturned() throws Exception {
    ...
    @Test
    void givenValidIoJAppealId_whenRollbackIoJAppealIsCalled_thenOKResponseIsReturned() throws Exception {
    ...
    @Test
    void givenAnInvalidIoJAppealId_whenRollbackIoJAppealIsCalled_thenNotFoundIsReturned() throws Exception {

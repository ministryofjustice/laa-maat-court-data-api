...
public class DigitalMeansAssessmentConvertor extends Convertor {
     ...
     */
    @Override
    public DigiMeansAssessType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof DigitisedMeansAssessmentDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + DigitisedMeansAssessmentDTO.class.getName());
    }

...
public class IOJTypeRef implements ORAData, ORADataFactory {
    ...
    public static IOJTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (IOJTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
    ...
    public IOJType getValue() throws SQLException {
        return (IOJType) IOJType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class PassportConfirmationTypeRef implements ORAData, ORADataFactory {
    ...
    private static final PassportConfirmationTypeRef _PassportConfirmationTypeRefFactory =
            new PassportConfirmationTypeRef();
    ...
    public static PassportConfirmationTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (PassportConfirmationTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException("Unable to convert " + o.getClass().getName() + " to PassportConfirmationTypeRef: "
                    + exn.toString());
        }
    }

    public PassportConfirmationType getValue() throws SQLException {
        return (PassportConfirmationType)
                PassportConfirmationType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class AreaTransferType implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "TOGDATA.AREA_TRANSFERSTYPE";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,12,2002,2002,2002,2002,2002,2002,91,91,2002,2002,93 };
  ...
  static
  {
    ...
    _factory[5] = TransferTypeType.getORADataFactory();
    _factory[6] = CmuType.getORADataFactory();
    _factory[7] = CmuType.getORADataFactory();
    _factory[10] = UserType.getORADataFactory();
    _factory[11] = UserType.getORADataFactory();
  }
  protected static final AreaTransferType _AreaTransferTypeFactory = new AreaTransferType();

  public static ORADataFactory getORADataFactory()
  { return _AreaTransferTypeFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[13], _sqlType, _factory); }
  public AreaTransferType()
  { _init_struct(true); }
  public AreaTransferType(java.math.BigDecimal id, String userCreated, TransferStatusType statusObject, AreaType areaFromObject, AreaType areaToObject, TransferTypeType transferTypeObject, CmuType cmuFromObject, CmuType cmuToObject, java.sql.Timestamp dateHmcsSent, java.sql.Timestamp dateHmcsReceived, UserType hmcsSentByUserObject, UserType hmcsReceivedByUserObject, java.sql.Timestamp timeStamp) throws SQLException
  { _init_struct(true);
    setId(id);
  ...
  protected ORAData create(AreaTransferType o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new AreaTransferType();
  ...
  { _struct.setAttribute(6, cmuFromObject); }
  ...
  { _struct.setAttribute(7, cmuToObject); }

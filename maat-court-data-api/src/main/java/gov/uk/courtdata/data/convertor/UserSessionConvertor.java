...
import gov.uk.courtdata.data.oracle.UserRoleTabType;
import gov.uk.courtdata.data.oracle.UserRoleType;
import gov.uk.courtdata.data.oracle.UserSessionType;
...
public class UserSessionConvertor extends Convertor
{
	...
	/* (non-Javadoc)
	 * @see uk.gov.lsc.maat.bus.data.dao.convertor.Convertor#setTypeFromDTO(java.lang.Object)
	 */
	@Override

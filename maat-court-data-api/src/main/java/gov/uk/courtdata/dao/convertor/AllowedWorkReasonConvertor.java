...
public class AllowedWorkReasonConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof AllowedWorkReasonDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AllowedWorkReasonDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
             ...
             */
            NewWorkReasonTabtype allowedWorkReasonPassportTabtype =
                    getOracleType().getPassport();
            /*
             ...
             */
            NewWorkReasonTabtype allowedWorkReasonEligibilityTabtype =
                    getOracleType().getEligibility();
            /*
             * set an empty collection
             */
    ...
    private void allowedWorkReasonForCrownCourtHardship()
            throws MAATApplicationException, MAATSystemException, SQLException {

        /*
         * Allowed Work Reason for Crown Court Hardship
         */
        NewWorkReasonTabtype allowedWorkReasonCrownCourtHardshipTabtype =
                getOracleType().getCchardship();
        /*
         * set an empty collection
         */
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getDTO().getPassportWorkReason() != null) {
                ...
                NewWorkReasonType[] newWorkReasonTypes =
                        new NewWorkReasonType[getDTO().getPassportWorkReason().size()];

                Iterator<NewWorkReasonDTO> itr =
                        getDTO().getPassportWorkReason().iterator();
            ...
            if (getDTO().getMeansAssessmentWorkReason() != null) {
                ...
                NewWorkReasonType[] newWorkReasonTypes = new NewWorkReasonType
                        [getDTO().getMeansAssessmentWorkReason().size()];

                Iterator<NewWorkReasonDTO> itr =
                        getDTO().getMeansAssessmentWorkReason().iterator();

...
public class HrSolicitorCostType implements ORAData, ORADataFactory {
    ...
    public HrSolicitorCostType(
            java.math.BigDecimal solicitorRate,
            java.math.BigDecimal solicitorHours,
            java.math.BigDecimal solicitorVat,
            java.math.BigDecimal solicitorDisb,
            java.math.BigDecimal solicitorEstTotalCost)
            throws SQLException {
        _init_struct(true);

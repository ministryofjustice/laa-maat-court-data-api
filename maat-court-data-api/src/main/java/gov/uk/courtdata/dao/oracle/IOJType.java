...
public class IOJType implements ORAData, ORADataFactory {
    ...
    public IOJType(
            ...
            AssStatusType appealStatus,
            String appealSetupResult,
            String appealDecisionResult,
            java.sql.Timestamp receivedDate,
            java.sql.Timestamp decisionDate,
            IOJDecisionReasonType decisionReasonObject,
            String notes,

...
public class FullAssessmentConvertor extends Convertor {
     ...
     */
    @Override
    public FullAssessmentType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof FullAssessmentDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + FullAssessmentDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setAdjustedLivingAllowance(
                            convertorHelper.toDouble(getOracleType().getAdjustedLivingAllowance()));
            getDTO().setOtherHousingNote(
                            convertorHelper.toString(getOracleType().getOtherHousingNote()));
            getDTO().setTotalAggregatedExpense(
                            convertorHelper.toDouble(getOracleType().getTotAggregatedExp()));
            getDTO().setTotalAnnualDisposableIncome(
                            convertorHelper.toDouble(getOracleType().getTotAnnualDisposableInc()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setTotAnnualDisposableInc(convertorHelper.toDouble(getDTO().getTotalAnnualDisposableIncome()));

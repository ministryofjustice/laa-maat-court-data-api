...
public class ContributionSummaryType implements ORAData, ORADataFactory {
    ...
    public ContributionSummaryType(
            ...
            java.math.BigDecimal monthlyContribs,
            java.math.BigDecimal upfrontContribs,
            String basedOn,
            String upliftApplied,
            java.sql.Timestamp effectiveDate,
            java.sql.Timestamp calcDate,
            String fileName,
            java.sql.Timestamp dateFileSent,
            java.sql.Timestamp dateFileReceived)
            throws SQLException {
        _init_struct(true);
        setId(id);

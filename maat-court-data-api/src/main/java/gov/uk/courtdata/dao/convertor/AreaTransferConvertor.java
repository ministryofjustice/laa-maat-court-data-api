...
public class AreaTransferConvertor extends Convertor {
     ...
     */
    @Override
    public AreaTransferType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof AreaTransferDetailsDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AreaTransferDetailsDTO.class.getName());
    }

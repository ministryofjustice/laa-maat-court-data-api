...
public class CorrespondenceType implements ORAData, ORADataFactory {
    ...
    public CorrespondenceType(
            ...
            CorrespondenceTypeType correspondenceTypeObject,
            java.sql.Timestamp generatedDate,
            java.sql.Timestamp printedDate,
            java.math.BigDecimal fiasId,
            String templateName,
            PrintDatesTabtype printDatesTab,
            java.sql.Timestamp originalEmailDate)
            throws SQLException {
        _init_struct(true);
        setId(id);

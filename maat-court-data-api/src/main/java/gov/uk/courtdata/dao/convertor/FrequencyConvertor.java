...
public class FrequencyConvertor extends Convertor {
    ...
    @Override
    public FrequencyType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof FrequenciesDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + FrequenciesDTO.class.getName());
    }

...
class WQHearingServiceTest {
    ...
    public void givenAValidMaatIdAndHearingUuid_whenFindByMaatIdAndHearingUUIDIsInvoked_shouldReturnWQHearningDTO() {
        ...
        when(wqHearingImpl.findByMaatIdAndHearingUUID(
                        TestEntityDataBuilder.REP_ID, TestEntityDataBuilder.TEST_OFFENCE_ID))
                .thenReturn(wqHearingEntityList);
        ...
        wqHearingService.findByMaatIdAndHearingUUID(
                TestEntityDataBuilder.REP_ID, TestEntityDataBuilder.TEST_OFFENCE_ID);

...
public class HrDetailTypeTypeRef implements ORAData, ORADataFactory {
    ...
    public static HrDetailTypeTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (HrDetailTypeTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to HrDetailTypeTypeRef: " + exn.toString());
        }
    }

    public HrDetailTypeType getValue() throws SQLException {
        return (HrDetailTypeType) HrDetailTypeType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

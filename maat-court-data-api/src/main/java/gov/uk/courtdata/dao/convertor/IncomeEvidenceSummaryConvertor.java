...
public class IncomeEvidenceSummaryConvertor extends Convertor {
     ...
     */
    @Override
    public IncomeEvidenceSummaryType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof IncomeEvidenceSummaryDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + IncomeEvidenceSummaryDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setIncomeEvidenceNotes(
                            convertorHelper.toString(getOracleType().getIncomeEvidenceNotes()));
            getDTO().setEvidenceDueDate(convertorHelper.toDate(getOracleType().getEvidenceDueDate()));
            getDTO().setEvidenceReceivedDate(
                            convertorHelper.toDate(getOracleType().getEvidenceReceivedDate()));
            ...
            getDTO().setSecondReminderDate(
                            convertorHelper.toDate(getOracleType().getSecondReminderDate()));
            getDTO().setEnabled(convertorHelper.toBoolean(getOracleType().getEnabled()));
            getDTO().setUpliftsAvailable(
                            convertorHelper.toBoolean(getOracleType().getUpliftsAvailable()));
            ...
            if (getOracleType().getApplicantIncomeEvidenceTab() != null) {
                IncomeEvidenceType[] ievTab =
                        getOracleType().getApplicantIncomeEvidenceTab().getArray();
            ...
            if (getOracleType().getPartnerIncomeEvidenceTab() != null) {
                IncomeEvidenceType[] ievTab =
                        getOracleType().getPartnerIncomeEvidenceTab().getArray();
                IncomeEvidenceConvertor convertor = new IncomeEvidenceConvertor();
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getDTO().getApplicantIncomeEvidenceList() != null) {
                IncomeEvidenceType[] ieTypes = new IncomeEvidenceType
                        [getDTO().getApplicantIncomeEvidenceList().size()];
                Iterator<EvidenceDTO> it =
                        getDTO().getApplicantIncomeEvidenceList().iterator();
                int idx = 0;
            ...
            if (getDTO().getPartnerIncomeEvidenceList() != null) {
                IncomeEvidenceType[] ieTypes = new IncomeEvidenceType
                        [getDTO().getPartnerIncomeEvidenceList().size()];
                Iterator<EvidenceDTO> it =
                        getDTO().getPartnerIncomeEvidenceList().iterator();
                int idx = 0;
            ...
            if (getDTO().getExtraEvidenceList() != null) {
                ExtraEvidenceType[] eeTypes =
                        new ExtraEvidenceType[getDTO().getExtraEvidenceList().size()];

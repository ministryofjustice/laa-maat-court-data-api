...
public class ApplicantPaymentDetailsConvertor extends Convertor {
     ...
     */
    @Override
    public ApplPaymentDetailsType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ApplicantPaymentDetailsDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ApplicantPaymentDetailsDTO.class.getName());
    }

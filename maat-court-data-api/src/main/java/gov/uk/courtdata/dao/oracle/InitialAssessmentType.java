...
public class InitialAssessmentType implements ORAData, ORADataFactory {
    ...
    public InitialAssessmentType(
            ...
            java.math.BigDecimal criteriaId,
            NewWorkReasonType newWorkReasonObject,
            String otherBenefitNote,
            String otherIncomeNote,
            java.math.BigDecimal totAggregatedIncome,
            java.math.BigDecimal adjustedIncomeValue,
            String notes,
            AssSectionSummaryTabType sectionSummariesTab,
            AssChildWeightingTabType childWeightingTab,
            java.math.BigDecimal lowerThreshold,
            java.math.BigDecimal upperThreshold,
            String result,
            String resultReason,

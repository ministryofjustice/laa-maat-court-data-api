...
import gov.uk.courtdata.dao.oracle.FinAssessmentType;
...
public class FinancialAssessmentConvertor extends Convertor {
     ...
     */
    @Override
    public FinAssessmentType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof FinancialAssessmentDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + FinancialAssessmentDTO.class.getName());
    }

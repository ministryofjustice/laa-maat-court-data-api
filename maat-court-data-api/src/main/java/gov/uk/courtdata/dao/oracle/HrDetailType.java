...
public class HrDetailType implements ORAData, ORADataFactory {
    ...
    public HrDetailType(
            ...
            FrequencyType frequencyObject,
            java.sql.Timestamp dateReceived,
            HrDetailDescriptionType hrDetailDescriptionObject,
            String otherDescription,
            java.math.BigDecimal amountNumber,
            java.sql.Timestamp dateDue,
            String accepted,
            HrReasonType hrReasonObject,
            String hrReasonNote,

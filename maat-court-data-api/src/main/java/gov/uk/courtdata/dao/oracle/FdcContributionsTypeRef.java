...
public class FdcContributionsTypeRef implements ORAData, ORADataFactory {
    ...
    public static FdcContributionsTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (FdcContributionsTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to FdcContributionsTypeRef: " + exn.toString());
        }
    }

    public FdcContributionsType getValue() throws SQLException {
        return (FdcContributionsType)
                FdcContributionsType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class AssessmentDetailType implements ORAData, ORADataFactory {
    ...
    public AssessmentDetailType(
            ...
            java.math.BigDecimal criteriaDetailId,
            java.math.BigDecimal applicantAmount,
            FrequencyType applicantFreqObject,
            java.math.BigDecimal partnerAmount,
            FrequencyType partnerFreqObject,
            String description,
            String detailCode,

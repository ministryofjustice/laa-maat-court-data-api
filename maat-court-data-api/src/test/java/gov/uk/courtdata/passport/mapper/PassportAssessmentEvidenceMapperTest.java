...
@ContextConfiguration(classes = {PassportAssessmentEvidenceMapperImpl.class, PassportAssessmentMapperHelper.class})
class PassportAssessmentEvidenceMapperTest {
    ...
    void givenPassportAssessmentEntity_whenMapToApiGetPassportEvidenceResponse_thenMetadataIsMapped() {
        ...
        ApiGetPassportEvidenceResponse response =
                passportAssessmentEvidenceMapper.toApiGetPassportEvidenceResponse(passportAssessmentEntity);
    ...
    void givenPassportAssessmentEvidenceEntity_whenMapToApiIncomeEvidence_thenEvidenceIsMapped() {
        ...
        PassportAssessmentEvidenceEntity evidenceEntity = buildApplicantEvidence(applicant, passportAssessmentEntity);

        ApiIncomeEvidence response = passportAssessmentEvidenceMapper.toApiIncomeEvidence(evidenceEntity);

        assertThat(response.getId()).isEqualTo(evidenceEntity.getId());
        assertThat(response.getDateReceived())
    ...
    private Applicant buildApplicant() {
        return Applicant.builder().id(APPLICANT_ID).build();
    }

    private PassportAssessmentEvidenceEntity buildApplicantEvidence(
            Applicant applicant, PassportAssessmentEntity passportAssessmentEntity) {
        PassportAssessmentEvidenceEntity passportAssessmentApplicantEvidenceEntity =
                TestEntityDataBuilder.getPassportAssessmentEvidenceEntity(
                        passportAssessmentEntity, applicant, DATE_TIME);

...
public class HrDetailDescriptionTypeRef implements ORAData, ORADataFactory {
    ...
    private static final HrDetailDescriptionTypeRef _HrDetailDescriptionTypeRefFactory =
            new HrDetailDescriptionTypeRef();
    ...
    public static HrDetailDescriptionTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (HrDetailDescriptionTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException("Unable to convert " + o.getClass().getName() + " to HrDetailDescriptionTypeRef: "
                    + exn.toString());
        }
    }

    public HrDetailDescriptionType getValue() throws SQLException {
        return (HrDetailDescriptionType)
                HrDetailDescriptionType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

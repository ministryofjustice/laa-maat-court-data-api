...
public class FinancialAssessmentControllerIntegrationTest extends MockMvcIntegrationTest {
    ...
    private void setupTestData() {
        ...
        List<FinancialAssessmentEntity> assessmentsToCreate = List.of(
                TestEntityDataBuilder.getCustomFinancialAssessmentEntity(
                        REP_ID_WITH_OUTSTANDING_ASSESSMENTS, "IN PROGRESS", newWorkReasonEntity),
                TestEntityDataBuilder.getCustomFinancialAssessmentEntity(
                        REP_ID_WITH_NO_OUTSTANDING_ASSESSMENTS, "COMPLETE", newWorkReasonEntity),
                TestEntityDataBuilder.getCustomFinancialAssessmentEntity(
                        REP_ID_WITH_OUTSTANDING_PASSPORT_ASSESSMENTS, "COMPLETE", newWorkReasonEntity),
    ...
    void givenAnInvalidAssessmentId_whenDeleteAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        Integer invalidAssessmentId = 999;
        assertTrue(runBadRequestErrorScenario(
                String.format("%d is invalid", invalidAssessmentId), delete(ASSESSMENT_URL, invalidAssessmentId)));
    }
    ...
    void givenAValidAssessmentId_whenDeleteAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        assertThat(runSuccessScenario(delete(
                                ASSESSMENT_URL,
                                existingAssessmentEntities.get(0).getId()))
                        .getResponse()
                        .getStatus())
                .isEqualTo(200);
    }
    ...
    void
        ...
        assertTrue(runSuccessScenario(
                expectedResponse, get(CHECK_OUTSTANDING_URL, REP_ID_WITH_NO_OUTSTANDING_ASSESSMENTS)));
    }
    ...
    void
        ...
        OutstandingAssessmentResultDTO expectedResponse = OutstandingAssessmentResultDTO.builder()
                ...
                .build();
        assertTrue(runSuccessScenario(
                expectedResponse, get(CHECK_OUTSTANDING_URL, REP_ID_WITH_OUTSTANDING_PASSPORT_ASSESSMENTS)));
    }
    ...
    void givenAnAssessmentWithNoRepId_whenCreateAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        assertTrue(runCreateAssessmentErrorScenario(
                "Rep Order ID is required", CreateFinancialAssessment.builder().build()));
    }
    ...
    void givenAValidAssessmentBody_whenCreateAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        ...
        expectedResponse
                ...
                .get(0)
                .setId(createdAssessment.getAssessmentDetails().get(0).getId());
        expectedResponse
                .getChildWeightings()
                .get(0)
                .setId(createdAssessment.getChildWeightings().get(0).getId());
        expectedResponse
                .getAssessmentDetails()
                .get(0)
                .setDateModified(createdAssessment.getAssessmentDetails().get(0).getDateModified());
    ...
    void givenAnAssessmentWithNoRepId_whenUpdateAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        assertTrue(runUpdateAssessmentErrorScenario(
                "Rep Order ID is required", UpdateFinancialAssessment.builder().build()));
    }
    ...
    void givenAnAssessmentWithNoUserModifiedSet_whenUpdateAssessmentIsInvoked_theCorrectResponseIsReturned()
        ...
        assertTrue(runUpdateAssessmentErrorScenario(
                "Username is required",
                UpdateFinancialAssessment.builder()
                        .id(existingAssessmentEntities.get(0).getId())
                        .repId(1)
                        .initialAscrId(1)
                        .cmuId(1)
                        .build()));
    ...
    void givenAnAssessmentWithIncomeEvidence_whenUpdateAssessmentIsInvoked_thenNewIncomeEvidenceIsReturned()
        ...
        FinancialAssessmentEntity assessmentToUpdate = existingAssessmentEntities.stream()
                .filter(item -> item.getRepOrder().getId().equals(REP_ID_WITH_NO_OUTSTANDING_ASSESSMENTS))
                .findFirst()
                .orElse(null);
        ...
        assertThat(updatedAssessment.getFinAssIncomeEvidences().get(0).getIncomeEvidence())
                .isEqualTo("WAGE SLIP");
    }
    ...
    void givenAValidAssessmentBody_whenUpdateAssessmentIsInvoked_theCorrectResponseIsReturned() throws Exception {
        ...
        if (updatedAssessment != null) {
            expectedResponse
                    .getAssessmentDetails()
                    .get(0)
                    .setId(updatedAssessment.getAssessmentDetails().get(0).getId());
            expectedResponse
                    .getChildWeightings()
                    .get(0)
                    .setId(updatedAssessment.getChildWeightings().get(0).getId());
        }
        ...
        expectedResponse
                .getAssessmentDetails()
                .get(0)
                .setDateModified(updatedAssessment.getAssessmentDetails().get(0).getDateModified());
    ...
    @Test
    public void
            givenValidFinancialAssessmentId_whenMeansAssessorDetailsIsInvoked_thenPopulatedAssessorDetailsAreReturned()
                    throws Exception {
    ...
    @Test
    public void givenUnknownFinancialAssessmentId_whenMeansAssessorDetailsIsInvoked_thenNotFoundResponseIsReturned()
            throws Exception {

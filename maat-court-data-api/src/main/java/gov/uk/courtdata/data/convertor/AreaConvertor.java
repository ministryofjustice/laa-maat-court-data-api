...
import gov.uk.courtdata.data.oracle.AreaType;
import gov.uk.courtdata.data.oracle.CMUTabType;
import gov.uk.courtdata.data.oracle.CmuType;
...
public class AreaConvertor extends Convertor
{
	...
	/* (non-Javadoc)
	 * @see uk.gov.lsc.maat.bus.data.dao.dto.GenericDTO#getOracleType()
	 */
	@Override

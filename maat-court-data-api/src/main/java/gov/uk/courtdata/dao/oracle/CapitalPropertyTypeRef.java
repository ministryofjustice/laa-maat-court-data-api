...
public class CapitalPropertyTypeRef implements ORAData, ORADataFactory {
    ...
    public static CapitalPropertyTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CapitalPropertyTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CapitalPropertyTypeRef: " + exn.toString());
        }
    }

    public CapitalPropertyType getValue() throws SQLException {
        return (CapitalPropertyType) CapitalPropertyType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class MagsCourtConvertor extends Convertor {
     ...
     */
    @Override
    public MagsCourtType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof MagsCourtDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + MagsCourtDTO.class.getName());
    }

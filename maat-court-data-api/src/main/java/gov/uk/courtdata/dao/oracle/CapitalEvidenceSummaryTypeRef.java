...
public class CapitalEvidenceSummaryTypeRef implements ORAData, ORADataFactory {
    ...
    private static final CapitalEvidenceSummaryTypeRef _CapitalEvidenceSummaryTypeRefFactory =
            new CapitalEvidenceSummaryTypeRef();
    ...
    public static CapitalEvidenceSummaryTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CapitalEvidenceSummaryTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException("Unable to convert " + o.getClass().getName() + " to CapitalEvidenceSummaryTypeRef: "
                    + exn.toString());
        }
    }

    public CapitalEvidenceSummaryType getValue() throws SQLException {
        return (CapitalEvidenceSummaryType)
                CapitalEvidenceSummaryType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

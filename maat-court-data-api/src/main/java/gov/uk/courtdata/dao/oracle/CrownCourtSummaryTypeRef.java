...
public class CrownCourtSummaryTypeRef implements ORAData, ORADataFactory {
    ...
    public static CrownCourtSummaryTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CrownCourtSummaryTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CrownCourtSummaryTypeRef: " + exn.toString());
        }
    }

    public CrownCourtSummaryType getValue() throws SQLException {
        return (CrownCourtSummaryType)
                CrownCourtSummaryType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

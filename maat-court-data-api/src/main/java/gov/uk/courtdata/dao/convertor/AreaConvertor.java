...
public class AreaConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof AreaDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AreaDTO.class.getName());
    }
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if ((getDTO().getCaseManagementUnits() != null)
                ...
                Iterator<CaseManagementUnitDTO> cIt =
                        getDTO().getCaseManagementUnits().iterator();
                int idx = 0;

...
public class ApplicationType implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 12, 91, 91, 12, 12, 12, 2002, 2, 91, 91, 12, 91, 91, 91, 12, 12, 93, 12, 2002, 2002, 2002, 2002, 2002, 2002,
        2002, 2002, 2002, 2002, 2002, 2002, 2002, 2003, 2002, 2002, 2003, 12, 12, 91, 2002, 2, 12, 12, 91, 91, 12, 12,
        2003
    };
    ...
    public ApplicationType(
            java.math.BigDecimal repId,
            String caseId,
            java.sql.Timestamp dateReceived,
            java.sql.Timestamp dateStatusSet,
            String arrestSummonsNo,
            String statusReason,
            String iojResult,
            CmuType cmuObject,
            java.math.BigDecimal areaId,
            java.sql.Timestamp committalDate,
            java.sql.Timestamp magsCourtOutcomeDate,
            String courtCustody,
            java.sql.Timestamp decisionDate,
            java.sql.Timestamp statusDueDate,
            java.sql.Timestamp magsWithdrawalDate,
            String welshCorrespondence,
            String partner,
            java.sql.Timestamp timeStamp,
            String alertMessage,
            ContraryInterestType contraryInterestObject,
            DecisionReasonType decisionReasonObject,
            RepStatusType statusObject,
            CaseTypeType caseTypeObject,
            OffenceTypeType offenceTypeObject,
            MagsCourtType magsCourtObject,
            OutcomeType magsOutcomeObject,
            ApplicantDetailsType applicantDetailsObject,
            SupplierType supplierObject,
            LSCTransferType lscTransfersObject,
            AreaTransferType areaTransfersObject,
            PassportAssessmentType passportAssessmentObject,
            AssessmentType currentAssessmentObject,
            AssessmentSummaryTabType assessmentsSummaryTab,
            CrownCourtOverviewType crownCourtOverviewObject,
            CapitalEquityType capitalEquityObject,
            ApplicantLinksTabtype applicantLinksTab,
            String transactionId,
            String retrial,
            java.sql.Timestamp appSignedDate,
            AllowedWorkReasonType allowedWorkReasons,
            java.math.BigDecimal usn,
            String iojResultNote,
            String solicitorName,
            java.sql.Timestamp efmDateStamp,
            java.sql.Timestamp hearingDate,
            String solicitorEmail,
            String solicitorAdminEmail,
            DigiMeansAssessTabtype digiMeansAssessments)
            throws SQLException {
        _init_struct(true);
        setRepId(repId);
        setCaseId(caseId);

...
public class UserRoleConvertor extends Convertor {
     ...
     */
    @Override
    public UserRoleType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof UserRoleDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + UserRoleDTO.class.getName());
    }

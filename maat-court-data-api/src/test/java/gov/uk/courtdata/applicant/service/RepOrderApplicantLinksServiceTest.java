...
public class RepOrderApplicantLinksServiceTest {
    ...
    void givenAValidInput_whenFindIsInvoked_thenShouldReturnListOfRepOrderApplicantLinksDTO() {
        when(repOrderApplicantLinksRepository.findAllByRepId(anyInt()))
                .thenReturn(List.of(RepOrderApplicantLinksEntity.builder()
    ...
    void givenAValidInput_whenUpdateIsInvoked_thenUpdateIsSuccess() {
        when(repOrderApplicantLinksRepository.findById(anyInt()))
                .thenReturn(Optional.of(
                        RepOrderApplicantLinksEntity.builder().id(ID).build()));
        when(repOrderApplicantLinksRepository.saveAndFlush(any()))
                .thenReturn(Mockito.mock(RepOrderApplicantLinksEntity.class));

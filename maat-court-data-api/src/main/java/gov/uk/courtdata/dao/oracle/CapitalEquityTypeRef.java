...
public class CapitalEquityTypeRef implements ORAData, ORADataFactory {
    ...
    public static CapitalEquityTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CapitalEquityTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CapitalEquityTypeRef: " + exn.toString());
        }
    }

    public CapitalEquityType getValue() throws SQLException {
        return (CapitalEquityType) CapitalEquityType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

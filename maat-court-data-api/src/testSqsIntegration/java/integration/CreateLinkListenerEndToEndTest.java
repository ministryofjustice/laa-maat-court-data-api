...
class CreateLinkListenerEndToEndTest {
    ...
    public static LocalStackContainer LOCALSTACK_CONTAINER =
            new LocalStackContainer(LOCALSTACK_IMAGE).withServices(SQS);
    ...
    static void beforeAll() {
        amazonSQS = TestUtils.getClientSQS(LOCALSTACK_CONTAINER
    ...
    private Integer numberOfMessagesInLinkQueue() {
        GetQueueAttributesResult attributes = amazonSQS.getQueueAttributes(queueUrl, of("All"));

...
public class AddressConvertor extends Convertor {
     ...
     */
    @Override
    public AddressType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof AddressDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setCounty(convertorHelper.toString(getOracleType().getCounty()));
            getDTO().setMDirty(dirty); // Do not change the DTO dirty flag when it has just been populated from the
            // database

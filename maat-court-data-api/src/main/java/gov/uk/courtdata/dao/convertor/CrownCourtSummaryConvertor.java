...
public class CrownCourtSummaryConvertor extends Convertor {
     ...
     */
    @Override
    public CrownCourtSummaryType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CrownCourtSummaryDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CrownCourtSummaryDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setBenchWarrantyIssued(
                            convertorHelper.toBoolean(getOracleType().getBenchWarrantIssued()));
            getDTO().setRepOrderDecision(
                            convertorHelper.toSysGenString(getOracleType().getCcReporderDecision()));
        ...
        try {
            ...
            if (getDTO().getOutcomeDTOs() != null) {
                ...
                OutcomeType[] outcomeTypes =
                        new OutcomeType[getDTO().getOutcomeDTOs().size()];

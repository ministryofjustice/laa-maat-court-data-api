...
public class AppealsType implements ORAData, ORADataFactory {
    ...
    public AppealsType(
            String available,
            java.sql.Timestamp appealReceivedDate,
            java.sql.Timestamp appealSentenceOrderDate,
            java.sql.Timestamp appealSentOrdDtDateSet,
            AppealTypeType appealTypeObject,
            java.sql.Timestamp appealTypeDateSet)
            throws SQLException {
        _init_struct(true);

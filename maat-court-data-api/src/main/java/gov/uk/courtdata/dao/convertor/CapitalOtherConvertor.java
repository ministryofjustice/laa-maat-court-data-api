...
public class CapitalOtherConvertor extends Convertor {
     ...
     */
    @Override
    public CapitalOtherType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CapitalOtherDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CapitalOtherDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setOtherDescription(
                            convertorHelper.toString(getOracleType().getOtherDescription()));
            ...
            getDTO().setVerifiedAmount(
                            convertorHelper.toCurrency(getOracleType().getVerifiedAmount()));
            getDTO().setDateEntered(convertorHelper.toSysGenDate(getOracleType().getDateEntered()));
            getDTO().setVerifiedDate(
                            convertorHelper.toSysGenDate(getOracleType().getVerifiedDate()));
            getDTO().setVerifiedBy(
                            convertorHelper.toSysGenString(getOracleType().getVerifiedBy()));
            ...
            if (getOracleType().getCapitalEvidenceTab() != null) {
                CapitalEvidenceType[] cevTab =
                        getOracleType().getCapitalEvidenceTab().getArray();
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getDTO().getCapitalEvidence() != null) {
                CapitalEvidenceType[] ceTypes =
                        new CapitalEvidenceType[getDTO().getCapitalEvidence().size()];
            ...
            if (getDTO().getExtraEvidence() != null) {
                ExtraEvidenceType[] eeTypes =
                        new ExtraEvidenceType[getDTO().getExtraEvidence().size()];

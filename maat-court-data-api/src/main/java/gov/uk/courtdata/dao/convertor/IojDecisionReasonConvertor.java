...
public class IojDecisionReasonConvertor extends Convertor {
     ...
     */
    @Override
    public IOJDecisionReasonType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof IOJDecisionReasonDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + IOJDecisionReasonDTO.class.getName());
    }

...
public class ExtraEvidenceConvertor extends Convertor {
     ...
     */
    @Override
    public ExtraEvidenceType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ExtraEvidenceDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ExtraEvidenceDTO.class.getName());
    }

...
import gov.uk.courtdata.dao.oracle.AssessmentDetailTabType;
import gov.uk.courtdata.dao.oracle.AssessmentDetailType;
...
public class AssessmentSectionSummaryConvertor extends Convertor {
    ...
    @Override
    public AssSectionSummaryType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof AssessmentSectionSummaryDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AssessmentSectionSummaryDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setApplicantAnnualTotal(
                            convertorHelper.toDouble(getOracleType().getAppAnnualTotal()));
            getDTO().setPartnerAnnualTotal(
                            convertorHelper.toDouble(getOracleType().getPartnerAnnualTotal()));

...
public class ReviewTypeConvertor extends Convertor {
     ...
     */
    @Override
    public ReviewTypeType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ReviewTypeDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ReviewTypeDTO.class.getName());
    }

...
public class PropertyType implements ORAData, ORADataFactory {
    ...
    public PropertyType(
            ...
            AddressType addressObject,
            ResidentialStatusType residentialStatusObject,
            PropertyTypeType propertyTypeObject,
            java.math.BigDecimal percentageOwnedApplicant,
            java.math.BigDecimal percentageOwnedPartner,
            String bedrooms,
            java.math.BigDecimal verifiedEquityAmount,
            java.math.BigDecimal declaredMarketValue,
            java.math.BigDecimal declaredMortgageCharges,
            java.math.BigDecimal declaredEquityAmount,
            java.math.BigDecimal verifiedMarketValue,
            java.math.BigDecimal verifiedMortgageCharges,
            ResidentialStatusType verifiedResidentialStatus,
            String tennantInPlace,
            java.sql.Timestamp timeStamp,
            ThirdPartyTabtype thirdPartyOwners)
            throws SQLException {
        _init_struct(true);
        setId(id);

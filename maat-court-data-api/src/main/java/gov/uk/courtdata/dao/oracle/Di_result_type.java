...
public class Di_result_type implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 2, 2, 91, 12, 12, 12, 12, 12, 91, 12, 12, 12, 91, 12, 12, 12, 12, 12, 12, 12, 2, 12, 12
    };
    ...
    public Di_result_type(
            ...
            java.sql.Timestamp dateAppCreated,
            String caseId,
            String iojResult,
            String iojAssessorName,
            String meansResult,
            String meansAssessorName,
            java.sql.Timestamp dateMeansCreated,
            String iojReason,
            String passportResult,
            String passportAssessorName,
            java.sql.Timestamp datePassportCreated,
            String dwpResult,
            String iojAppealResult,
            String hardshipResult,
            String repOrderDecision,
            String ccRepOrdDec,
            String fundingDecision,
            String caseType,
            java.math.BigDecimal assessmentId,

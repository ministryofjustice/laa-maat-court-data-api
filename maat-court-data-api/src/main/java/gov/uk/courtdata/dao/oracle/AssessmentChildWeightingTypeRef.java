...
public class AssessmentChildWeightingTypeRef implements ORAData, ORADataFactory {
    ...
    private static final AssessmentChildWeightingTypeRef _AssessmentChildWeightingTypeRefFactory =
            new AssessmentChildWeightingTypeRef();
    ...
    public static AssessmentChildWeightingTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (AssessmentChildWeightingTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException("Unable to convert " + o.getClass().getName()
                    + " to AssessmentChildWeightingTypeRef: " + exn.toString());
        }
    }

    public AssessmentChildWeightingType getValue() throws SQLException {
        return (AssessmentChildWeightingType)
                AssessmentChildWeightingType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public interface PassportAssessmentMapper {
    ...
    PassportAssessmentDTO passportAssessmentEntityToPassportAssessmentDTO(
            final PassportAssessmentEntity passportAssessment);

    @Mapping(target = "repOrder.id", source = "repId")
    PassportAssessmentEntity passportAssessmentDtoToPassportAssessmentEntity(
            final PassportAssessmentDTO passportAssessment);
}

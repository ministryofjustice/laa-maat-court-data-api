...
public class FdcItemConvertor extends Convertor {
     ...
     */
    @Override
    public FdcItemsType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof FdcItemDTO) {
            ...
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + FdcItemDTO.class.getName());
        }
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getOracleType().getAdjustmentReason() != null) {
                ...
                adjustmentReason.setCode(
                        convertorHelper.toString(getOracleType().getAdjustmentReason()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getDTO().getAdjustmentReason() != null) {
                ...
                getOracleType()
                        .setAdjustmentReason(convertorHelper.toString(
                                getDTO().getAdjustmentReason().getCode()));
            }

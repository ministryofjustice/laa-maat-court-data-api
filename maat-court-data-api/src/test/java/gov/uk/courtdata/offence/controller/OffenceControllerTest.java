...
class OffenceControllerTest {
    ...
    void givenValidCaseId_whenFindOffenceByCaseIdIsInvoked_thenReturnOffence() throws Exception {
        List<OffenceDTO> offenceDTOList = List.of(TestModelDataBuilder.getOffenceDTO(313123));
    ...
    void givenValidParameters_whenGetNewOffenceCountIsInvoked_thenReturnCorrectNewOffenceCount(int expectedCount)
            throws Exception {
        when(offenceService.getNewOffenceCount(TestModelDataBuilder.TEST_CASE_ID, TestModelDataBuilder.TEST_OFFENCE_ID))

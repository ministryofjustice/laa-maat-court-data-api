    ...
    void givenWQHearingProcessor_whenProcessIsInvoke_thenSaveWQHearingEntity() {
        ...
        when(wqLinkRegisterRepository.findBymaatId(anyInt()))
                .thenReturn(Collections.singletonList(
                        WqLinkRegisterEntity.builder().maatId(121112).build()));
        ...
        assertThat(wqHearingEntityArgumentCaptor.getValue().getHearingUUID())
                .isEqualTo("9dc76cb3-a996-4660-8386-bab551007ac7");
        assertThat(wqHearingEntityArgumentCaptor.getValue().getMaatId()).isEqualTo(TestModelDataBuilder.REP_ID);
        assertThat(wqHearingEntityArgumentCaptor.getValue().getWqJurisdictionType())
                .isEqualTo(JurisdictionType.CROWN.name());
        assertThat(wqHearingEntityArgumentCaptor.getValue().getOuCourtLocation())
                .isEqualTo("1212");
        ...
        return HearingResulted.builder()
                ...
                .defendant(Defendant.builder()
                        .offences(Arrays.asList(
                                Offence.builder()
                                        .results(Collections.singletonList(Result.builder()
                                                .resultCode("3030")
                                                .build()))
                                        .build(),
                                Offence.builder()

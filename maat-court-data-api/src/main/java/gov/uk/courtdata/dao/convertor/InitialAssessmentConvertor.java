...
import gov.uk.courtdata.dao.oracle.AssChildWeightingTabType;
...
import gov.uk.courtdata.dao.oracle.InitialAssessmentType;
...
public class InitialAssessmentConvertor extends Convertor {
     ...
     */
    @Override
    public InitialAssessmentType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof InitialAssessmentDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + InitialAssessmentDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setOtherBenefitNote(
                            convertorHelper.toString(getOracleType().getOtherBenefitNote()));
            getDTO().setOtherIncomeNote(convertorHelper.toString(getOracleType().getOtherIncomeNote()));
            getDTO().setTotalAggregatedIncome(
                            convertorHelper.toDouble(getOracleType().getTotAggregatedIncome()));
            getDTO().setAdjustedIncomeValue(
                            convertorHelper.toDouble(getOracleType().getAdjustedIncomeValue()));
            ...
            getDTO().setNewWorkReason(
                            mwrConvertor.getDTO()); // if type is null this will initialise a valid empty object
            ...
            getDTO().setAssessmnentStatusDTO(
                            assConvertor.getDTO()); // if type is null this will initialise a valid empty object
            ...
            if (getOracleType().getSectionSummariesTab() != null) {
                AssSectionSummaryType[] sectionSummaryTypes =
                        getOracleType().getSectionSummariesTab().getArray();
            ...
            if (getOracleType().getChildWeightingTab() != null) {
                AssessmentChildWeightingType[] childWeightings =
                        getOracleType().getChildWeightingTab().getArray();
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setNewWorkReasonObject(
                            mwrConvertor.getOracleType()); // if type is null this will initialise a valid empty object
            ...
            getOracleType()
                    .setStatusObject(
                            assConvertor.getOracleType()); // if type is null this will initialise a valid empty object

            // Section summaries

            if (getDTO().getSectionSummaries() != null) {
                AssSectionSummaryType[] sectionSummaryTypes =
                        new AssSectionSummaryType[getDTO().getSectionSummaries().size()];
                Iterator<AssessmentSectionSummaryDTO> It =
                        getDTO().getSectionSummaries().iterator();
                int i = 0;
            ...
            if (getDTO().getChildWeightings() != null
                    && getDTO().getChildWeightings().size() > 0) {
                AssessmentChildWeightingType[] assChildWeightingTypes = new AssessmentChildWeightingType
                        [getDTO().getChildWeightings().size()];

...
public class CapitalTypeTypeRef implements ORAData, ORADataFactory {
    ...
    public static CapitalTypeTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (CapitalTypeTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to CapitalTypeTypeRef: " + exn.toString());
        }
    }

    public CapitalTypeType getValue() throws SQLException {
        return (CapitalTypeType) CapitalTypeType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public interface ConcorContributionsRepository extends JpaRepository<ConcorContributionsEntity, Integer> {
    ...
    List<IdOnly> findByStatusAndIdGreaterThan(ConcorContributionStatus status, Integer startId, Pageable pageable);

    List<IdOnly> findByStatusAndFullXmlIsNotNullOrderByIdDesc(ConcorContributionStatus status, Pageable pageable);

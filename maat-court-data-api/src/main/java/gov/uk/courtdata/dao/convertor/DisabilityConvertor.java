...
public class DisabilityConvertor extends Convertor {
     ...
     */
    @Override
    public DisabilityType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof DisabilityDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + DisabilityDTO.class.getName());
    }

...
public class EmploymentStatusConvertor extends Convertor {
     ...
     */
    @Override
    public EmpStatusType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof EmploymentStatusDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + EmploymentStatusDTO.class.getName());
    }

...
public class HrSectionType implements ORAData, ORADataFactory {
    ...
    public HrSectionType(
            HrDetailTypeType hrDetailTypeObject,
            HRDetailTabType hrDetailTab,
            java.math.BigDecimal appAnnualTotal,
            java.math.BigDecimal partnerAnnualTotal,
            java.math.BigDecimal annualTotal)
            throws SQLException {
        _init_struct(true);

...
public class ContraryInterestConvertor extends Convertor {
     ...
     */
    @Override
    public ContraryInterestType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ContraryInterestDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ContraryInterestDTO.class.getName());
    }

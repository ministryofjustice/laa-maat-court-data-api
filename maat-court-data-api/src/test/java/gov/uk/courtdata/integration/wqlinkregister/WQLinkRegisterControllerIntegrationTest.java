...
class WQLinkRegisterControllerIntegrationTest extends MockMvcIntegrationTest {
    ...
    void givenAInvalidMaatId_whenFindOffenceByMaatIdIsInvoked_thenEmptyRecordsIsReturned() throws Exception {
        assertThat(runSuccessScenario(List.of(), get(ENDPOINT_URL + "/" + INVALID_REP_ID)))
                .isTrue();
    }
    ...
    void givenAValidMaatId_whenFindOffenceByMaatIdIsInvoked_thenWQLinkRegisterIsReturned() throws Exception {
        List<WqLinkRegisterEntity> wqLinkRegisterEntityList =
                List.of(TestEntityDataBuilder.getWQLinkRegisterEntity(8064716));
        assertThat(runSuccessScenario(wqLinkRegisterEntityList, get(ENDPOINT_URL + "/" + TestModelDataBuilder.REP_ID)))
                .isTrue();
    }
}

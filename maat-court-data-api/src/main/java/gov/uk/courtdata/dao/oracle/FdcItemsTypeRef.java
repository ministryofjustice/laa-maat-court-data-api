...
public class FdcItemsTypeRef implements ORAData, ORADataFactory {
    ...
    public static FdcItemsTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (FdcItemsTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to FdcItemsTypeRef: " + exn.toString());
        }
    }

    public FdcItemsType getValue() throws SQLException {
        return (FdcItemsType) FdcItemsType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

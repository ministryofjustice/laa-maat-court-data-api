...
public class CorrespondenceTypeConvertor extends Convertor {
     ...
     */
    @Override
    public CorrespondenceTypeType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CorrespondenceTypeDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setCorrespondenceType(
                            convertorHelper.toString(getOracleType().getCorrespondenceType()));

...
public class DefendantInfoProcessor implements Process {
    ...
    public void process(CourtDataDTO courtDataDTO) {
        ...
        DefendantEntity defendantEntity = DefendantEntity.builder()
                ...
                .addressLine1(defendant.getAddressLine1())
                .addressLine2(defendant.getAddressLine2())
                .addressLine3(defendant.getAddressLine3())
                .addressLine4(defendant.getAddressLine4())
                .addressLine5(defendant.getAddressLine5())

...
public interface PassportAssessmentMapper {
     ...
     * Returns true or false based on two different criteria:
     * <ul>
     *     <li>If the request has declaredUnder18, or no declaredBenefit then will return false </li>
     ...
     * @return Boolean
     */
    default Boolean mapBenefitType(BenefitType expected, ApiCreatePassportedAssessmentRequest request) {
    ...
    default Boolean mapUnder18CourtType(boolean isMags, ApiCreatePassportedAssessmentRequest request) {

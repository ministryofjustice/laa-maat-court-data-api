...
public class PaymentMethodConvertor extends Convertor {
     ...
     */
    @Override
    public PaymentMethodType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof PaymentMethodDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + PaymentMethodDTO.class.getName());
    }

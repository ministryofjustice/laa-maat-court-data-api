...
public class UserQueryConvertor extends Convertor {
     ...
     */
    @Override
    public UserQueryType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof SearchUserDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + SearchUserDTO.class.getName());
    }

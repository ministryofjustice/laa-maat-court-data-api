...
import gov.uk.courtdata.dao.oracle.FrequencyType;
...
public class AssessmentDetailConvertor extends Convertor {
    ...
    @Override
    public AssessmentDetailType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof AssessmentDetailDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + AssessmentDetailDTO.class.getName());
    }

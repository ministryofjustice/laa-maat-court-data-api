...
public class IojAppealConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof IOJAppealDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + IOJAppealDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setAppealSetUpResult(
                            convertorHelper.toString(getOracleType().getAppealSetupResult()));
            getDTO().setAppealDecisionResult(
                            convertorHelper.toString(getOracleType().getAppealDecisionResult()));

...
public class FdcContributionsConvertor extends Convertor {
     ...
     */
    @Override
    public FdcContributionsType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof FdcContributionDTO) {
            ...
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + FdcContributionDTO.class.getName());
        }
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setJudicialApportionment(
                            convertorHelper.toDouble(getOracleType().getJaPercent()));
            ...
            getDTO().setManualAcceleration(
                            convertorHelper.toBoolean(getOracleType().getAccelerate()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if ((getDTO().getAgfsCosts() != null) && (getDTO().getAgfsCosts().size() > 0)) {
                ...
                FdcItemsType[] fdcItemsTypes =
                        new FdcItemsType[getDTO().getAgfsCosts().size()];
            ...
            if ((getDTO().getLgfsCosts() != null) && (getDTO().getLgfsCosts().size() > 0)) {
                ...
                FdcItemsType[] fdcItemsTypes =
                        new FdcItemsType[getDTO().getLgfsCosts().size()];

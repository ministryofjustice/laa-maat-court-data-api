...
public class FinancialAssessmentHistoryImpl {
    ...
    public FinancialAssessmentsHistoryEntity buildAndSave(
            final FinancialAssessmentsHistoryDTO financialAssessmentsHistoryDTO, final int financialAssessmentId) {
        FinancialAssessmentsHistoryEntity financialAssessmentsHistoryEntity =
                assessmentHistoryMapper.financialAssessmentsHistoryDTOToFinancialAssessmentsHistoryEntity(
                        financialAssessmentsHistoryDTO);

        log.info(
                "Executing save financialAssessmentsHistoryEntity for financialAssessmentId: {}",

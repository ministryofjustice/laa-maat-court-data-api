...
public class ReportDataType implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 2, 12, 91, 12, 12, 91, 2, 2, 2, 2, 2, 2, 2, 12, 12, 91, 2, 12, 12, 91, 91, 91, 91, 12, 2, 2, 2, 2, 2, 12, 12,
        12, 12, 12, 12, 93, 12, 12, 91, 12, 2, 2, 2, 2, 2, 2, 91, 12, 91, 91, 91, 2, 12, 12, 91, 12, 91, 91, 2, 91, 91,
        12, 12, 91, 2, 2, 2, 2, 91, 2, 91, 12, 12, 12, 12, 12, 12, 12, 12, 2, 91, 12, 12, 12, 12, 12, 12, 12, 12, 12,
        12, 91, 91, 91, 91, 91, 91, 12, 2, 2, 2, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 91, 12, 2, 12, 93,
    ...
    public ReportDataType(
            ...
            java.math.BigDecimal areaId,
            String areaName,
            java.sql.Timestamp runDate,
            String timePeriodCovered,
            String cmuName,
            java.sql.Timestamp weekBeginning,
            java.math.BigDecimal processedInTwo,
            java.math.BigDecimal processedOutTwo,
            java.math.BigDecimal processedInThree,
            java.math.BigDecimal processedOutThree,
            java.math.BigDecimal processedInSix,
            java.math.BigDecimal processedOutSix,
            java.math.BigDecimal processedTotal,
            String staffName,
            String typeOfWork,
            java.sql.Timestamp dateReceived,
            java.math.BigDecimal maatId,
            String caseId,
            String appSurname,
            java.sql.Timestamp datePending,
            java.sql.Timestamp dateSent,
            java.sql.Timestamp dateCompleted,
            java.sql.Timestamp dateReturned,
            String dwpType,
            java.math.BigDecimal dwpTotalChecks,
            java.math.BigDecimal dwpPassed,
            java.math.BigDecimal dwpFailed,
            java.math.BigDecimal dwpNotDetermined,
            java.math.BigDecimal dwpSearchNotPossible,
            String userName,
            String roleDescription,
            String userRoleEnabled,
            String enabled,
            String transFromAreaName,
            String transFromCmuName,
            java.sql.Timestamp timeStamp,
            String transToAreaName,
            String transToCmuName,
            java.sql.Timestamp userLoginDate,
            String caseStatusDescr,
            java.math.BigDecimal processedGranted,
            java.math.BigDecimal processedFailed,
            java.math.BigDecimal dwpDeleted,
            java.math.BigDecimal dwpDeceased,
            java.math.BigDecimal dwpSuperseded,
            java.math.BigDecimal cmuId,
            java.sql.Timestamp drivingEventDate,
            String caseType,
            java.sql.Timestamp magistrateCommittalDate,
            java.sql.Timestamp assessmentDate,
            java.sql.Timestamp outcomeDate,
            java.math.BigDecimal numberOfDays,
            String appFirstName,
            String court,
            java.sql.Timestamp evidenceDueDate,
            String transferType,
            java.sql.Timestamp referralDate,
            java.sql.Timestamp dateOfBirth,
            java.math.BigDecimal fdcAmountSent,
            java.sql.Timestamp fdcCalculationDate,
            java.sql.Timestamp fdcDateSent,
            String empStatus,
            String crownCourtOutcome,
            java.sql.Timestamp sentenceOrderDate,
            java.math.BigDecimal totalDeclaredCapital,
            java.math.BigDecimal totalAgfsComponent,
            java.math.BigDecimal totalLgfsComponent,
            java.math.BigDecimal agfsAdjustmentAmt,
            java.sql.Timestamp dateAgfsAdjusted,
            java.math.BigDecimal lgfsAdjustmentAmt,
            java.sql.Timestamp dateLgfsAdjusted,
            String agfsAdjustmentReason,
            String lgfsAdjustmentReason,
            String supplierCode,
            String caseNumber,
            String offenceType,
            String magsOutcome,
            ...
            java.sql.Timestamp contributionDateSent,
            String appealType,
            String arrestSummonsNumber,
            String crownCourtCode,
            String crownCourtName,
            String iojResult,
            String iojAppealResult,
            String hearingResult,
            String hearingType,
            String repType,
            String errorMessage,
            java.sql.Timestamp dateCaseCreated,
            java.sql.Timestamp repOrderDecisionDate,
            java.sql.Timestamp ccRepOrderDate,
            java.sql.Timestamp fullAssessmentDate,
            java.sql.Timestamp incomeEvidencePrintDate,
            java.sql.Timestamp contrNoticeOrderPrintDate,
            String capitalEquityStatus,
            java.math.BigDecimal processedInSeven,
            java.math.BigDecimal processedOutSeven,
            java.math.BigDecimal appsNotCompleted,
            String fullAssessmentOutstanding,
            String incEvidReqNeedsPrinting,
            String contrNotOrdNeedsPrinting,
            String capitalEquityIncomplete,
            String xtraFailureReason,
            String previousFdcFileSent,
            String nullMaatCommittalDate,
            String nullMaatAsn,
            String committalDateUnmatched,
            String asnUnmatched,
            String lastNameUnmatched,
            String firstNameUnmatched,
            String dobUnmatched,
            java.sql.Timestamp dateOfLastMatchAttempt,
            String crownCourtImprisoned,
            java.math.BigDecimal numberOfCharges,
            String xhibitFileName,
            java.sql.Timestamp xhibitFileTimestamp,
            String benchWarrantIssued,
            String repOrderStatus,
            String xhibitCcOutcome,
            java.sql.Timestamp xhibitCcOutcomeDate,
            String ccRepOrderDecision,
            String ccRepOrderWithdrawn,
            java.sql.Timestamp ccRoWithdrawalDate,
            oracle.sql.CLOB chargeDetails,
            java.math.BigDecimal workTypeOrder,
            String billScenario,
            java.sql.Timestamp dateBillPaid,
            String altMaatRefs,
            java.math.BigDecimal totalAsns,
            java.math.BigDecimal dummyAsns,
            String contrNoticeNeedsPrinting,
            String contrOrderNeedsPrinting,
            String incEvidReqNeedsGenerating,
            String incEvidRemNeedsPrinting,
            String capEvidReqNeedsGenerating,
            String capEvidReqNeedsPrinting,
            java.math.BigDecimal volTotalTrials,
            java.math.BigDecimal volContrNoticesNeedPrint,
            java.math.BigDecimal volContrOrdersNeedPrint,
            java.math.BigDecimal volIncEvidReqsNeedPrint,
            java.math.BigDecimal volIncEvidRemsNeedPrint,
            java.math.BigDecimal volCapEvidReqsNeedPrint,
            java.math.BigDecimal volIncEvidReqsNeedGen,
            java.math.BigDecimal volCapEvidReqsNeedGen)
            throws SQLException {
        _init_struct(true);

...
public class HardshipReviewConvertor extends Convertor {
     ...
     */
    @Override
    public HardshipReviewType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ApplicationHardshipReviewDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setSolictorsCosts(
                            solConvertor.getDTO()); // if type is null this will initialise a valid empty object

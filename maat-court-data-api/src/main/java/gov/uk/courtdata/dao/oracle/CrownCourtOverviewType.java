...
public class CrownCourtOverviewType implements ORAData, ORADataFactory {
    ...
    public CrownCourtOverviewType(
            String available,
            CrownCourtSummaryType crownCourtSummaryObject,
            ContributionsType contributionsObject,
            ContributionSummaryTabType contributionSummaryTab,
            ApplPaymentDetailsType applPaymentDetailsObject,
            CorrespondenceTabType correspondenceTab,
            AppealsType appealObject)
            throws SQLException {
        _init_struct(true);

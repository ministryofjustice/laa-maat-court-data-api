...
public class FinAssessmentType implements ORAData, ORADataFactory {
    ...
    public FinAssessmentType(
            java.math.BigDecimal finAssessmentId,
            InitialAssessmentType initialAssessmentObject,
            FullAssessmentType fullAssessmentObject,
            IncomeEvidenceSummaryType incomeEvidenceSummaryObject,
            HardshipOverviewType hardshipOverviewObject,
            String fullAvailable,

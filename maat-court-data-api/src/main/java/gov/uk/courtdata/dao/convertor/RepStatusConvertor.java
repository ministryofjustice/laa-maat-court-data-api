...
public class RepStatusConvertor extends Convertor {
     ...
     */
    @Override
    public RepStatusType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof RepStatusDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + RepStatusDTO.class.getName());
    }

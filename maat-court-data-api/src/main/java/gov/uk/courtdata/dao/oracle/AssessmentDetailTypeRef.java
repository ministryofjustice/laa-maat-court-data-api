...
public class AssessmentDetailTypeRef implements ORAData, ORADataFactory {
    ...
    public static AssessmentDetailTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (AssessmentDetailTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to AssessmentDetailTypeRef: " + exn.toString());
        }
    }

    public AssessmentDetailType getValue() throws SQLException {
        return (AssessmentDetailType)
                AssessmentDetailType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

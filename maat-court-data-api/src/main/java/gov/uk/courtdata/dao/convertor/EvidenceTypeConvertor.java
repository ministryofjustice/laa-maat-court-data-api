...
import gov.uk.courtdata.dao.oracle.EvidenceTypeType;
...
public class EvidenceTypeConvertor extends Convertor {
     ...
     */
    @Override
    public EvidenceTypeType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof EvidenceTypeDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + EvidenceTypeDTO.class.getName());
    }

...
public class AppSearchDetailsTypeRef implements ORAData, ORADataFactory {
    ...
    public static AppSearchDetailsTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (AppSearchDetailsTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to AppSearchDetailsTypeRef: " + exn.toString());
        }
    }

    public AppSearchDetailsType getValue() throws SQLException {
        return (AppSearchDetailsType)
                AppSearchDetailsType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

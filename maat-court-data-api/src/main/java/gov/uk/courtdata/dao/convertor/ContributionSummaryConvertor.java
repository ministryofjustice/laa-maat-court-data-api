...
public class ContributionSummaryConvertor extends Convertor {
     ...
     */
    @Override
    public ContributionSummaryType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ContributionSummaryDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ContributionSummaryDTO.class.getName());
    }

...
public class CourtApplicationsPreProcessorTest {
    ...
    public void testApplicationFlagAndASNSeqForNewApplication() {
        ...
        Mockito.when(xlatOffenceRepository.findById(any()))
    ...
    public void testApplicationFlagAndASNSeqForExistingApplication() {
        ...
        Mockito.when(offenceRepository.findApplicationByOffenceCode(any(), any(), any()))
                .thenReturn(Optional.of(OffenceEntity.builder()
                        .applicationFlag(1)
                        .asnSeq("1006")
                        .build()));
    ...
    private Defendant getDefendant() {
        ...
        return Defendant.builder()
                .offences(Collections.singletonList(getOffence()))
                .build();
    }

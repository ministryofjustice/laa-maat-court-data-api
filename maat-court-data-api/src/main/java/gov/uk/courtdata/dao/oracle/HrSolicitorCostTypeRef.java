...
public class HrSolicitorCostTypeRef implements ORAData, ORADataFactory {
    ...
    public static HrSolicitorCostTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (HrSolicitorCostTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to HrSolicitorCostTypeRef: " + exn.toString());
        }
    }

    public HrSolicitorCostType getValue() throws SQLException {
        return (HrSolicitorCostType) HrSolicitorCostType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

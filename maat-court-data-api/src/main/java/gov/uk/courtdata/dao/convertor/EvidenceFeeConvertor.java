...
import gov.uk.courtdata.dao.oracle.EvidenceFeeType;
...
public class EvidenceFeeConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof EvidenceFeeDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + EvidenceFeeDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setDescription(
                            convertorHelper.toSysGenString(getOracleType().getDescription()));

...
public class IncomeEvidenceSummaryType implements ORAData, ORADataFactory {
    ...
    protected static final IncomeEvidenceSummaryType _IncomeEvidenceSummaryTypeFactory =
            new IncomeEvidenceSummaryType();
    ...
    public IncomeEvidenceSummaryType(
            ...
            java.sql.Timestamp evidenceReceivedDate,
            java.sql.Timestamp upliftAppliedDate,
            java.sql.Timestamp upliftRemovedDate,
            java.sql.Timestamp firstReminderDate,
            java.sql.Timestamp secondReminderDate,
            String incomeEvidenceNotes,
            String enabled,
            String upliftsAvailable,
            IncomeEvidenceTabType applicantIncomeEvidenceTab,
            IncomeEvidenceTabType partnerIncomeEvidenceTab,
            ExtraEvidenceTabtype extraEvidenceTab)
            throws SQLException {
        _init_struct(true);

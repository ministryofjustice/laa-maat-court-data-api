...
public class CaseDetailConvertor extends Convertor {
     ...
     */
    @Override
    public CaseTypeType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CaseDetailDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CaseDetailDTO.class.getName());
    }

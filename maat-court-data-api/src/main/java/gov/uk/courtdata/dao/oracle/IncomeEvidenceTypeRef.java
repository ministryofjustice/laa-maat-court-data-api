...
public class IncomeEvidenceTypeRef implements ORAData, ORADataFactory {
    ...
    public static IncomeEvidenceTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (IncomeEvidenceTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to IncomeEvidenceTypeRef: " + exn.toString());
        }
    }

    public IncomeEvidenceType getValue() throws SQLException {
        return (IncomeEvidenceType) IncomeEvidenceType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

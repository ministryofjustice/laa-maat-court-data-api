...
public class HRSolictorsCostsConvertor extends Convertor {
     ...
     */
    @Override
    public HrSolicitorCostType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof HRSolicitorsCostsDTO) this.setDto(dto);
        else
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setSolicitorEstimatedTotalCost(
                            convertorHelper.toCurrency(getOracleType().getSolicitorEstTotalCost()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setSolicitorEstTotalCost(convertorHelper.toCurrency(getDTO().getSolicitorEstimatedTotalCost()));

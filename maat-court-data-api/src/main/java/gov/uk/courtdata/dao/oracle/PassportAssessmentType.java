...
public class PassportAssessmentType implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 2, 2002, 91, 12, 12, 12, 12, 91, 12, 12, 12, 2002, 2002, 12, 93, 12, 12, 12, 12, 91, 12, 12, 12, 12, 2002, 2,
        12, 2002, 12
    };
    ...
    public PassportAssessmentType(
            ...
            AssStatusType statusObject,
            java.sql.Timestamp assDate,
            String partnerBenefitClaimed,
            String partnerFirstName,
            String partnerSurname,
            String partnerNiNo,
            java.sql.Timestamp partnerDob,
            String incomeSupport,
            String jobSeekers,
            String statePensionCredit,
            NewWorkReasonType newWorkReasonObject,
            PassportConfirmationType confirmationObject,
            String result,
            java.sql.Timestamp timeStamp,
            String dwpResult,
            String passportNote,
            String under18HeardYouthCourt,
            String under18HeardMagsCourt,
            java.sql.Timestamp lastSignOnDate,
            String esa,
            String under18FullEducation,
            String under16,
            String between1617,
            IncomeEvidenceSummaryType incomeEvidenceSummaryObject,
            java.math.BigDecimal usn,
            String whoDwpChecked,
            ReviewTypeType reviewTypeObject,
    ...
    public void setIncomeEvidenceSummaryObject(IncomeEvidenceSummaryType incomeEvidenceSummaryObject)
            throws SQLException {

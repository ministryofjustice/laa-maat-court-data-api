...
class RepOrderMvoRegServiceTest {
    ...
    void givenValidMvoId_whenFindByCurrentMvoRegistrationIsInvoked_thenRepOrderMvoRegIsReturned() {
        when(repOrderMvoRegImpl.findByCurrentMvoRegistration(anyInt()))
                .thenReturn(TestEntityDataBuilder.getRepOrderMvoRegEntityInfo());
        when(repOrderMvoRegMapper.repOrderMvoRegEntityInfoToRepOrderMvoRegDTO(anyList()))
                .thenReturn(TestModelDataBuilder.getRepOrderMvoRegDTOList());
        assertThat(repOrderMvoRegService.findByCurrentMvoRegistration(TestModelDataBuilder.MVO_ID))
                .isEqualTo(TestModelDataBuilder.getRepOrderMvoRegDTOList());
    }
}

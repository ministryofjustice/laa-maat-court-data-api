...
public class CapitalOtherType implements ORAData, ORADataFactory {
    ...
    public CapitalOtherType(
            ...
            CapitalTypeType capitalTypeObject,
            String otherDescription,
            AssStatusType assetStatusObject,
            java.math.BigDecimal assetAmount,
            java.math.BigDecimal verifiedAmount,
            java.sql.Timestamp dateEntered,
            CapitalEvidenceTabType capitalEvidenceTab,
            ExtraEvidenceTabtype extraEvidenceTab,
            java.sql.Timestamp verifiedDate,
            String verifiedBy,
            String undeclared,

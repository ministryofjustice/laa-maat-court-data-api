...
public class HardshipOverviewTypeRef implements ORAData, ORADataFactory {
    ...
    public static HardshipOverviewTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (HardshipOverviewTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to HardshipOverviewTypeRef: " + exn.toString());
        }
    }

    public HardshipOverviewType getValue() throws SQLException {
        return (HardshipOverviewType)
                HardshipOverviewType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

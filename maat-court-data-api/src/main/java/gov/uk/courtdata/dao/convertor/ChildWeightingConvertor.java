...
public class ChildWeightingConvertor extends Convertor {
     ...
     */
    @Override
    public AssessmentChildWeightingType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ChildWeightingDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ChildWeightingDTO.class.getName());
    }

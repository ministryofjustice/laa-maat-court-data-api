...
public class FdcContributionsType implements ORAData, ORADataFactory {
    ...
    public FdcContributionsType(
            ...
            java.sql.Timestamp dateCalculated,
            java.sql.Timestamp dateReplaced,
            String status,
            String lgfsComplete,
            String agfsComplete,
            java.math.BigDecimal finalCost,
            java.math.BigDecimal vat,
            java.math.BigDecimal lgfsCost,
            java.math.BigDecimal agfsCost,
            java.math.BigDecimal lgfsVat,
            java.math.BigDecimal agfsVat,
            FdcItemsTabtype lgfsCosts,
            FdcItemsTabtype agfsCosts,
            DrcFileType drcFile,
            FdcNotesTabtype notesTab,
            java.math.BigDecimal jaPercent,
            String accelerate)
            throws SQLException {
        _init_struct(true);
        setId(id);

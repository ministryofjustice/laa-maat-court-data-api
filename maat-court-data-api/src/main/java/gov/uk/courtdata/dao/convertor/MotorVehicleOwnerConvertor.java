...
import gov.uk.courtdata.dao.oracle.MotorVehicleOwnerType;
import gov.uk.courtdata.dao.oracle.MvoRegTabtype;
...
public class MotorVehicleOwnerConvertor extends Convertor {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof MotorVehicleOwnerDTO) {
            ...
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + MotorVehicleOwnerDTO.class.getName());
        }
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setNoVehicleDeclared(
                            convertorHelper.toBoolean(getOracleType().getNoVehicleDeclared()));
            ...
            if (getOracleType().getRegistrationTab() != null) {
                ...
                VehicleRegistrationMarkConvertor vehicleRegistrationMarkConvertor =
                        new VehicleRegistrationMarkConvertor();
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if ((getDTO().getVehicleRegistrationMarkDTOs() != null)
                    && (getDTO().getVehicleRegistrationMarkDTOs()).size() > 0) {

                MvoRegType[] movRegTypes =
                        new MvoRegType[getDTO().getVehicleRegistrationMarkDTOs().size()];

                Iterator<VehicleRegistrationMarkDTO> vehicleRegistrations =
                        getDTO().getVehicleRegistrationMarkDTOs().iterator();

                int idx = 0;

                while (vehicleRegistrations.hasNext()) {

                    VehicleRegistrationMarkDTO vehicleRegistrationMarkDTO =
                            (VehicleRegistrationMarkDTO) vehicleRegistrations.next();
                    VehicleRegistrationMarkConvertor vehicleRegistrationMarkConvertor =
                            new VehicleRegistrationMarkConvertor();

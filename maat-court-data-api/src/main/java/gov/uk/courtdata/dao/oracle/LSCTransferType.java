...
public class LSCTransferType implements ORAData, ORADataFactory {
    ...
    protected static int[] _sqlType = {
        2, 12, 2002, 2002, 2002, 2002, 2002, 2002, 91, 91, 91, 91, 2002, 2002, 2002, 2002, 93
    };
    ...
    public LSCTransferType(
            ...
            java.sql.Timestamp dateLscReceived,
            java.sql.Timestamp dateLscReturned,
            java.sql.Timestamp dateHmcsReceived,
            UserType hmcsSentByUserObject,
            UserType lscReceivedByUserObject,

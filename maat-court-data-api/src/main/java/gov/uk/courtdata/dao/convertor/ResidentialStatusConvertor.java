...
import gov.uk.courtdata.dao.oracle.ResidentialStatusType;
...
public class ResidentialStatusConvertor extends Convertor {
     ...
     */
    @Override
    public ResidentialStatusType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof ResidentialStatusDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ResidentialStatusDTO.class.getName());
    }

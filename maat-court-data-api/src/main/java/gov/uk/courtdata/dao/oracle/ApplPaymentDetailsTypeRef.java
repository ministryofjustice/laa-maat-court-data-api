...
public class ApplPaymentDetailsTypeRef implements ORAData, ORADataFactory {
    ...
    public static ApplPaymentDetailsTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (ApplPaymentDetailsTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to ApplPaymentDetailsTypeRef: " + exn.toString());
        }
    }

    public ApplPaymentDetailsType getValue() throws SQLException {
        return (ApplPaymentDetailsType)
                ApplPaymentDetailsType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

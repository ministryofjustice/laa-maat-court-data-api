...
public class CorrespondenceConvertor extends Convertor {
     ...
     */
    @Override
    public CorrespondenceType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CorrespondenceDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CorrespondenceDTO.class.getName());
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getDTO().setOriginalEmailDate(convertorHelper.toDate(
                    getOracleType().getOriginalEmailDate())); // MW - 30/03/2017 - FIP Changes
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            getOracleType()
                    .setOriginalEmailDate(
                            convertorHelper.toDate(getDTO().getOriginalEmailDate())); // MW - 30/03/2017 - FIP Changes
            CorrespondenceTypeConvertor typeConverter = new CorrespondenceTypeConvertor();
            if (getOracleType().getCorrespondenceTypeObject() != null) {

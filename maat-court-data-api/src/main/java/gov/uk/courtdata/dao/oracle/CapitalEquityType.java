...
public class CapitalEquityType implements ORAData, ORADataFactory {
    ...
    public CapitalEquityType(
            String available,
            String noCapitalDeclared,
            String sufficientVeriToCoverCase,
            String sufficientDeclToCoverCase,
            String verifiedEquityToCoverCase,
            String declaredEquityToCoverCase,
            java.math.BigDecimal totalCapital,
            java.math.BigDecimal totalEquity,
            java.math.BigDecimal totalCapitalAndEquity,
            EquityTabtype equityTab,
            CapitalPropertiesTabType capitalPropertiesTab,
            CapitalOtherTabType capitalOtherTab,
            CapitalEvidenceSummaryType capitalEvidenceSummaryObj,
            MotorVehicleOwnerType motorVehicleOwnerObj)
            throws SQLException {
        _init_struct(true);

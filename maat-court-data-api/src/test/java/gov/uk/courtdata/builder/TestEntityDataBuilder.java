...
public class TestEntityDataBuilder {
    ...
    public static PassportAssessmentEntity getPassportAssessmentEntity(Integer repId) {
        return PassportAssessmentEntity.builder()
                ...
                .incomeSupport(true)
                .jobSeekers(true)
                .statePensionCredit(false)
                .under18FullEducation(false)
                .under16(false)
                ...
                .userModified(TEST_USER)
                .dwpResult("Yes")
                .between16And17(false)
                .under18HeardInYouthCourt(false)
                .under18HeardInMagsCourt(false)

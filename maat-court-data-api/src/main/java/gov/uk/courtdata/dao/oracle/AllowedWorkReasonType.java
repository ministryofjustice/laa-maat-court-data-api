...
public class AllowedWorkReasonType implements ORAData, ORADataFactory {
    ...
    public AllowedWorkReasonType(
            NewWorkReasonTabtype passport,
            NewWorkReasonTabtype means,
            NewWorkReasonTabtype mchardship,
            NewWorkReasonTabtype cchardship,
            NewWorkReasonTabtype eligibility,
            NewWorkReasonTabtype ioj)
            throws SQLException {
        _init_struct(true);

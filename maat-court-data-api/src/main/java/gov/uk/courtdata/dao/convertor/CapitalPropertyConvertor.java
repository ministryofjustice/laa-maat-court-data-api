...
public class CapitalPropertyConvertor extends Convertor {
     ...
     */
    @Override
    public CapitalPropertyType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof CapitalPropertyDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + CapitalPropertyDTO.class.getName());
    }

...
@Repository
public interface RoleWorkReasonsRepository extends JpaRepository<RoleWorkReasonsEntity, Integer> {
    ...
    Optional<RoleWorkReasonsEntity> getNewWorkReason(@Param("username") String username, @Param("nworCode") String nworCode);
}

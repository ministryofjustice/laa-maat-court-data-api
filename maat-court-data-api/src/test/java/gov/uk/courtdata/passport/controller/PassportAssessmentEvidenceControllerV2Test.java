...
class PassportAssessmentEvidenceControllerV2Test {
    ...
    @Test
    void givenValidLegacyPassportAssessmentId_whenFindIsCalled_thenReturnValidPassportEvidenceResponse()
            throws Exception {
        when(passportAssessmentEvidenceService.find(LEGACY_PASSPORT_ASSESSMENT_ID))
                .thenReturn(TestModelDataBuilder.getApiGetPassportedEvidenceResponse());
    ...
    @Test
    void givenValidLegacyPassportAssessmentIdWithNoEvidence_whenFindIsCalled_thenReturnEmptyValuesResponse()
            throws Exception {

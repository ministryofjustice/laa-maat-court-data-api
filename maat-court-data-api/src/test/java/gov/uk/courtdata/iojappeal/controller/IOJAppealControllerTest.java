...
class IOJAppealControllerTest {
    ...
    void givenNonExistentIOJAppealID_WhenGetIOJAppealIsCalled_ThenReturnBadRequestResponse_Error() throws Exception {
        when(iojAppealService.find(IOJ_APPEAL_ID))
                .thenThrow(new RequestedObjectNotFoundException("No IoJAppeal object found. ID: " + IOJ_APPEAL_ID));
        mvc.perform(MockMvcRequestBuilders.get(ENDPOINT_URL + "/" + IOJ_APPEAL_ID))
    ...
    @Test
    void givenCorrectParameters_whenGetCurrentPassedIOJAppealByRepIdIsCalled_thenReturnValidIOJAppealResponse_Success()
            throws Exception {
        IOJAppealDTO iojAppealDTO = TestModelDataBuilder.getIOJAppealDTO();
    ...
    @Test
    void givenInvalidRepId_whenGetCurrentPassedIOJAppealByRepIdIsCalled_then404NotFoundErrorIsThrown()
            throws Exception {
    ...
    @Test
    void givenValidCreateIOJAppeal_whenCreateIOJAppealIsCalled_thenReturnCreatedIOJAppealObjectWithID()
            throws Exception {
        // given
    ...
    @Test
    void givenInvalidCreateIOJAppeal_whenCreateIOJAppealIsCalled_thenFailRequestParameterSchemaValidation()
            throws Exception {
        // given
    ...
    @Test
    void givenInvalidUpdateIOJAppeal_whenUpdateOJAppealIsCalled_thenFailRequestParameterSchemaValidation()
            throws Exception {
        // given
    ...
    void givenUpdateIOJAppeal_whenUpdateOJAppealIsCalled_AndValidationFails_thenReturnError() throws Exception {
        ...
        when(iojAppealValidationProcessor.validate(updateIOJAppeal))
                .thenThrow(new ValidationException("IoJ Appeal does not exist in Db. ID: " + updateIOJAppeal.getId()));
        ...
        mvc.perform(MockMvcRequestBuilders.put(ENDPOINT_URL)
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(
                        jsonPath("$.message").value("IoJ Appeal does not exist in Db. ID: " + updateIOJAppeal.getId()));
    }
}

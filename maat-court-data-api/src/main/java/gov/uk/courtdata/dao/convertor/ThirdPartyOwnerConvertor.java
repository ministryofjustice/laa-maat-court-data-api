...
public class ThirdPartyOwnerConvertor extends Convertor {
    ...
    @Override
    public ThirdPartyType getOracleType() throws MAATApplicationException, MAATSystemException {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        ...
        if (dto instanceof ThirdPartyOwnerDTO) {
            ...
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + ThirdPartyOwnerDTO.class.getName());
        }
    }
    ...
    public void setDTOFromType(Object oracleType) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getOracleType().getOwnerRelation() != null) {
                ...
                thirdPartyTypeDTO.setCode(
                        convertorHelper.toString(getOracleType().getOwnerRelation()));
    ...
    public void setTypeFromDTO(Object dto) throws MAATApplicationException, MAATSystemException {
        ...
        try {
            ...
            if (getDTO().getOwnerRelation() != null) {
                ...
                getOracleType()
                        .setOwnerRelation(convertorHelper.toString(
                                getDTO().getThirdPartyType().getCode()));
            }

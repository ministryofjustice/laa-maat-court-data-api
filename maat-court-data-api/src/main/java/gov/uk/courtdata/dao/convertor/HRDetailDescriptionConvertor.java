...
public class HRDetailDescriptionConvertor extends Convertor {
     ...
     */
    @Override
    public HrDetailDescriptionType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof HRDetailDescriptionDTO) this.setDto(dto);
        else

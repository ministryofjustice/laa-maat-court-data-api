...
public class ApplicantDetailsTypeRef implements ORAData, ORADataFactory {
    ...
    public static ApplicantDetailsTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (ApplicantDetailsTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to ApplicantDetailsTypeRef: " + exn.toString());
        }
    }

    public ApplicantDetailsType getValue() throws SQLException {
        return (ApplicantDetailsType)
                ApplicantDetailsType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
class SaveAndLinkImplIntegrationTest extends MockMvcIntegrationTest {
    ...
    private void verifyDefendant(CourtDataDTO courtDataDTO) {
        ...
        assertThat(defendantEntity.getDateOfBirth())
                .isEqualTo(courtDataDTO.getCaseDetails().getDefendant().getDateOfBirth());
    ...
    private void verifyProceeding(CourtDataDTO courtDataDTO) {
        ...
        ProceedingMaatId proceedingMaatId =
    ...
    private void verifyWqLinkRegister(CourtDataDTO courtDataDTO) {
        ...
        assertThat(wqLinkRegisterEntity.getMaatCat())
                .isEqualTo(courtDataDTO.getSolicitorMAATDataEntity().getCmuId());
        assertThat(wqLinkRegisterEntity.getMlrCat())
                .isEqualTo(courtDataDTO.getSolicitorMAATDataEntity().getCmuId());
    ...
    private void verifyCase(CourtDataDTO courtDataDTO) {
        ...
        assertThat(caseEntity.getDocLanguage())
                .isEqualTo(courtDataDTO.getCaseDetails().getDocLanguage());

...
public class EmiSimpleReportTypeRef implements ORAData, ORADataFactory {
    ...
    public static EmiSimpleReportTypeRef cast(ORAData o) throws SQLException {
        ...
        try {
            return (EmiSimpleReportTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF);
        } catch (Exception exn) {
            throw new SQLException(
                    "Unable to convert " + o.getClass().getName() + " to EmiSimpleReportTypeRef: " + exn.toString());
        }
    }

    public EmiSimpleReportType getValue() throws SQLException {
        return (EmiSimpleReportType) EmiSimpleReportType.getORADataFactory().create(_ref.getSTRUCT(), OracleTypes.REF);
    }

...
public class LSCTransferConvertor extends Convertor {
     ...
     */
    @Override
    public LSCTransferType getOracleType() throws MAATApplicationException, MAATSystemException {
        if (getDbType() == null) {
    ...
    public void setDTO(Object dto) throws MAATApplicationException {
        if (dto instanceof LscTransferDTO) this.setDto(dto);
        else
            throw new MAATApplicationException(" Invalid DTO type for conversion got "
                    + dto.getClass().getName() + " wanted " + LscTransferDTO.class.getName());
    }
